...
\begin{frame}{Main Result: SE Under User Load}
    \small
    \centering
    ...
    \begin{columns}[T,onlytextwidth]
        \begin{column}{0.47\textwidth}
            \scriptsize
            \textbf{Environment:} $K=30,40,50,60,70$, $L=200$, $N=8$, $\tauc=150$, $\taup^{design}=15$, 50 setups $\times$ 10 channel samples, MC SE.
        \end{column}
        \begin{column}{0.49\textwidth}
            \scriptsize
            \textbf{Interpretation:} update after the common-ground K-sweep output is generated.
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Mechanism: Pilot Count vs SINR Balance}
    ...
    \begin{columns}[T,onlytextwidth]
        \begin{column}{0.44\textwidth}
            ...
            \scriptsize
            $K=50$, $L=200$, $N=8$, $\tauc=150$, $\taup^{design}=15$, 200 setups $\times$ 20 channel samples.
    ...
    \begin{columns}[T,onlytextwidth]
        \begin{column}{0.48\textwidth}
            ...
            \begin{tightitemize}
                ...
                \item Common-ground K-sweep will supply the final load-dependent result.
    ...
    \begin{columns}[T,onlytextwidth]
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{center}
                ...
                \begin{tabular}{rccc}
                    \toprule
                    K  & AP-Top-N & Weighted & Resource matching \\
                    \midrule
...
\begin{frame}{Backup: Graph Consistency Rules}
    ...
    \begin{tightenumerate}
        ...
        \item Do not claim user-load crossover unless the common-ground K-sweep shows it.
